...
@section('content')
  ...
  <style>
    ...
    .hero {
      ...
      height: 69vh;
      background: linear-gradient(rgba(0,0,0,.6), rgba(0,0,0,.6)), url("{{ asset('images/fixing-solar.webp') }}");
  ...
  <section class="hero">
    <div class="hero-overlay">
      <h1>Powering Your World With Clean Energy</h1>
    </div>
  </section>
